...
export default function WebsiteDevelopmentSkeleton() {
  ...
  return (
    <MeshGlowBackground>
      <View style={styles.container}>
        ...
        <View style={styles.header}>
          <View style={styles.headerTop}>
            ...
            <View style={styles.headerInfo}>
              ...
              <SkeletonBox width={150} height={24} style={styles.projectTypeBadge} />
            </View>
          </View>
        </View>
        ...
        {/* Last Update Card Skeleton */}
        <GlassSurface style={styles.card}>
          <View style={styles.cardHeader}>
            <View style={styles.updateHeader}>
              <SkeletonBox width={20} height={20} style={styles.updateIcon} />
              <SkeletonBox width={100} height={20} style={styles.cardTitle} />
            </View>
          </View>
          <SkeletonBox width="50%" height={20} style={styles.updateText} />
        </GlassSurface>
