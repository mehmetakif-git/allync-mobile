  ...
  useEffect(() => {
    const loadMedia = async () => {
      if (activeTab === 'gallery' && project?.id) {
        ...
        try {
          console.log('📱🎨 Loading media for mobile app project:', project.id);
          const media = await getProjectMedia(project.id, 'mobile-app');
              ...
              {loadingMedia ? (
                ...
                <View style={styles.emptyGallery}>
                  ...
                  <Text style={[styles.emptyText, { color: colors.textSecondary }]}>
                    Your project manager will upload images and videos as your mobile app development progresses.
                  </Text>
                </View>
              ) : (
