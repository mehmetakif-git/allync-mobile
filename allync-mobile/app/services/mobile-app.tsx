...
export default function MobileAppDevelopment() {
    ...
    try {
      ...
      setProject({
        ...
        features: [
          ...
          { name: 'User Profile', completed: false },
        ],
      });
    } catch (error) {
  ...
  const getPlatformLabel = (platform: PlatformType) => {
    const labels = {
      ...
      both: { en: 'iOS & Android', tr: 'iOS & Android' },
    };
        ...
        <View style={[styles.container, { backgroundColor: colors.background }]}>
          <View style={styles.loadingContainer}>
            ...
            <Text style={[styles.loadingText, { color: colors.textSecondary }]}>
              {language === 'en' ? 'Loading Mobile App Project...' : 'Mobil Uygulama Projesi yükleniyor...'}
            </Text>
          </View>
        </View>
      </PageTransition>
          ...
          <View style={styles.headerContent}>
            ...
            <View style={styles.headerText}>
              <Text style={styles.headerTitle}>
                {language === 'en' ? 'Mobile App Development' : 'Mobil Uygulama Geliştirme'}
              </Text>
        ...
        >
          {activeTab === 'dashboard' && project && (
            <>
              ...
              >
                ...
                <View style={styles.progressContainer}>
                  <View style={styles.progressBar}>
                    <LinearGradient
                      colors={[getStatusColor(project.status), Colors.cyan[500]]}
                      start={{ x: 0, y: 0 }}
                      end={{ x: 1, y: 0 }}
              ...
              >
                <Ionicons name="phone-portrait" size={32} color={Colors.blue[500]} />
                <View style={styles.platformInfo}>
                  <Text style={[styles.platformLabel, { color: colors.textSecondary }]}>
                    {language === 'en' ? 'Target Platform' : 'Hedef Platform'}
                  </Text>
                  <Text style={[styles.platformValue, { color: colors.text }]}>
                    {getPlatformLabel(project.platform)}
                  </Text>
                </View>
                <View style={styles.platformIcons}>
                  {(project.platform === 'ios' || project.platform === 'both') && (
                    <View style={[styles.platformIconBadge, { backgroundColor: Colors.gray[800] }]}>
                      <Ionicons name="logo-apple" size={20} color="#FFFFFF" />
                    </View>
                  )}
                  {(project.platform === 'android' || project.platform === 'both') && (
                    <View style={[styles.platformIconBadge, { backgroundColor: Colors.green[600] }]}>
              ...
              <Animated.View entering={FadeInDown.duration(400).delay(400)}>
                <View style={styles.actionsGrid}>
                  ...
                  >
                    <Ionicons name="download" size={20} color={Colors.blue[500]} />
                  ...
                  >
                    <Ionicons name="play" size={20} color={Colors.green[500]} />
                    <Text style={[styles.actionButtonText, { color: colors.text }]}>
            ...
            <Animated.View entering={FadeIn.duration(400)}>
              ...
              >
                ...
                <Text style={[styles.emptyText, { color: colors.textSecondary }]}>
                  {language === 'en'
                    ? 'View detailed information about your mobile app project'
                    : 'Mobil uygulama projeniz hakkında detaylı bilgileri görüntüleyin'}
                </Text>
              </View>
            </Animated.View>
          )}
          ...
          {activeTab === 'gallery' && (
            <Animated.View entering={FadeIn.duration(400)}>
              ...
              >
                ...
                <Text style={[styles.emptyText, { color: colors.textSecondary }]}>
                  {language === 'en'
                    ? 'View screenshots and demo videos of your mobile app'
                    : 'Mobil uygulamanızın ekran görüntülerini ve demo videolarını görüntüleyin'}
                </Text>
              </View>
            </Animated.View>
          )}
