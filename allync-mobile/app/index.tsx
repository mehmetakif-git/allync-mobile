...
// Logo with smooth glow effect - locked to dark mode
function LogoWithGlow() {
  ...
  const glowColor1 = 'rgba(248, 249, 250, 0.15)';
  const glowColor2 = 'rgba(248, 249, 250, 0.25)';
  return (
...
export default function Index() {
  ...
  const particleColor = 'rgba(248, 249, 250, 0.4)';
  return (
